...
DATA_ROOT_DIR='/root/autodl-tmp/newcfdemo/CFdemo_Text/datasets_csv/reports_clean' # where are the TCGA features stored?
BASE_DIR="/root/autodl-tmp/newcfdemo/CFdemo_Text"            # where is the repo cloned?
