...
# 临床数据路径
clinical_input_path = f'/root/autodl-tmp/newcfdemo/CFdemo/datasets_csv/metadata/tcga_{cancer_type}.csv'
# 基因表达数据路径
rna_input_path = f'/root/autodl-tmp/newcfdemo/CFdemo/datasets_csv/raw_rna_data/combine/{cancer_type}/rna_clean.csv'
