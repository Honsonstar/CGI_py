...
DATA_ROOT_DIR='/root/autodl-tmp/newcfdemo/CFdemo_Text_pathway/datasets_csv/reports_clean' # where are the TCGA features stored?
BASE_DIR="/root/autodl-tmp/newcfdemo/CFdemo_Text_pathway"            # where is the repo cloned?
